...
try {
    ...
    if (isset($_SESSION['auth_id'])) {
        ...
        if (isset($_POST['membership_type']) && isset($_POST['price'])) {
    ...
    $session = \Stripe\Checkout\Session::create([
        ...
        'mode' => 'payment',
        'success_url' => "http://localhost/BelleAfrique/public/subscribe.php",
    ...
    if (!empty($session->id) && !empty($session->amount_subtotal)) {
        ...
        $newMembership = $client->subscribeMembership($Data, $Transid, $userID);

        $_SESSION['transaction-id'] = $session->id;
        $_SESSION['transaction-amount'] = $session->amount_subtotal;
        $_SESSION['membership'] = $membership_type;
    }
} catch (Exception $th) {
    //throw $th;
    echo $th->getMessage();
                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                ...
                                <ul role="list" class="-my-6 divide-y divide-gray-200">
                                    <li class="flex py-6">
                                        <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                                            <img src="./images/pexels-media-853151-1650840604090.jpeg">
                                        </div>
                                        ...
                                        <div class="ml-4 flex flex-1 flex-col">
                                            <div>
                                                <div class="flex justify-between text-base font-medium text-gray-900">
                                                    <h3>
                                                        <a href="#"><?php echo $membership_type; ?> </a>
                                                    </h3>
                                                    <p class="ml-4">MK<?php echo $price; ?>.00</p>
                                                </div>
                                                <p class="mt-1 text-sm text-gray-500">Membership plan </p>
                                            </div>
                    ...
                    <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                        <div class="flex justify-between text-base font-medium text-gray-900">
                            ...
                            <p>Total</p>
                            <p> Mk <?php echo $price; ?>.00</p>
                        </div>
                        <p class="mt-0.5 text-sm text-gray-500">Shipping and taxes calculated at checkout.</p>

                        <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
                            <p>
                                <button id="subscribe-button" type="button" class="font-medium text-indigo-600 hover:text-indigo-500">Subscribe<span aria-hidden="true"> &rarr;</span></button>
                            </p>
                            <script>
