  ...
  try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (!empty($username && !empty($password))) {
        ...
        $newUser = $client->loginAuth($username, $password);
        
        if(!empty($newUser)){
          
          $_SESSION['auth_id'] = $newUser->username;
        ...
        <div class="max-w-md w-full space-y-8">
          ...
          <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <a href="signup.php" class="font-medium text-indigo-600 hover:text-indigo-500"> Or Create account</a>
              </div>
            </div>
            <div>
            ...
            <div class="bg-gray-100 text-center">
              <p class="text-red-700 font-semibold tracking-tight">
                <?php
